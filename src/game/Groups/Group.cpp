...
void Group::ChangeMembersGroup(ObjectGuid guid, uint8 group, bool sendUpdate /*= true*/)
{
    if (!IsRaidGroup())
        return;
    ...
    if (!player)
    {
        ...
        ChangeMembersGroup(player, group, sendUpdate);
}

// only for online members
void Group::ChangeMembersGroup(Player* player, uint8 group, bool sendUpdate /*= true*/)
{
