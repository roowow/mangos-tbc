...
ChatCommand* ChatHandler::getCommandTable()
{
    ...
    {
        { "list",           SEC_ADMINISTRATOR,      false, &ChatHandler::HandleChannelListCommand,              "", nullptr },
        { "static",         SEC_ADMINISTRATOR,      false, &ChatHandler::HandleChannelStaticCommand,            "", nullptr },
        { nullptr,          0,                  false, nullptr,                                             "", nullptr }
    };
    ...
    static ChatCommand debugCommandTable[] =
    {
        ...
        { "areatriggers",   SEC_ADMINISTRATOR,      false, &ChatHandler::HandleDebugAreaTriggersCommand,        "", nullptr },
    ...
    static ChatCommand modifyCommandTable[] =
    {
        ...
        { "aspeed",         SEC_ADMINISTRATOR,      false, &ChatHandler::HandleModifyASpeedCommand,        "", nullptr },
...
//     };
    ...
    static ChatCommand sendCommandTable[] =
    {
        ...
        { "mail",           SEC_ADMINISTRATOR,      true,  &ChatHandler::HandleSendMailCommand,            "", nullptr },
...
#include "Anticheat/module/AnticheatChatCommands.h"
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "channel",        SEC_ADMINISTRATOR,      false, nullptr,                                        "", channelCommandTable  },
        ...
        { "modify",         SEC_ADMINISTRATOR,      false, nullptr,                                        "", modifyCommandTable   },
        { "npc",            SEC_ADMINISTRATOR,      false, nullptr,                                        "", npcCommandTable      },
        ...
        { "appear",         SEC_ADMINISTRATOR,      false, &ChatHandler::HandleGonameCommand,              "", nullptr },
        { "namego",         SEC_MODERATOR,      false, &ChatHandler::HandleNamegoCommand,              "", nullptr },
        { "summon",         SEC_ADMINISTRATOR,      false, &ChatHandler::HandleNamegoCommand,              "", nullptr },
        ...
        { "whispers",       SEC_ADMINISTRATOR,      false, &ChatHandler::HandleWhispersCommand,            "", nullptr },
        ...
        { "send",           SEC_ADMINISTRATOR,      true,  nullptr,                                        "", sendCommandTable },
        { "loadscripts",    SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleLoadScriptsCommand,         "", nullptr },
        { "mute",           SEC_ADMINISTRATOR,      true,  &ChatHandler::HandleMuteCommand,                "", nullptr },
        { "unmute",         SEC_ADMINISTRATOR,      true,  &ChatHandler::HandleUnmuteCommand,              "", nullptr },
