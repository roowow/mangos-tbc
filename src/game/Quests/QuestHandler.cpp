...
void WorldSession::HandleQuestLogRemoveQuest(WorldPacket& recv_data)
{
    ...
    {
        // Original inline logic, now shared via Player::AbandonQuestInSlot() so
        // Player::AbandonQuestsRequiringSkill() (called on profession unlearn) can reuse it:
        //
        ...
        _player->AbandonQuestInSlot(slot);
    }
}
